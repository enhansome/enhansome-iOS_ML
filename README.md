...
* [Convnet.js](http://cs.stanford.edu/people/karpathy/convnetjs/) - ConvNetJS is a Javascript library for training Deep Learning models by [Andrej Karpathy](https://twitter.com/karpathy). [GitHub](https://github.com/karpathy/convnetjs) ⭐ 11,202 | 🐛 75 | 🌐 JavaScript | 📅 2023-01-07
  * [ConvNetSwift](https://github.com/alexsosn/ConvNetSwift) ⭐ 42 | 🐛 1 | 🌐 Swift | 📅 2017-03-10 - Swift port \[work in progress].
* [tiny-dnn](https://github.com/tiny-dnn/tiny-dnn) ⭐ 6,031 | 🐛 297 | 🌐 C++ | 📅 2022-04-17 - header only, dependency-free deep learning framework in C++11.
  * [iOS example](https://github.com/tiny-dnn/tiny-dnn/tree/d4fff53fa0d01f59eb162de2ec32c652a1f6f467/examples/ios) ⭐ 6,031 | 🐛 297 | 🌐 C++ | 📅 2022-04-17
...
* [TensorFlow](http://www.tensorflow.org/) - an open source software library for numerical computation using data flow graphs. Nodes in the graph represent mathematical operations, while the graph edges represent the multidimensional data arrays (tensors) communicated between them. The flexible architecture allows you to deploy computation to one or more CPUs or GPUs in a desktop, server, or mobile device with a single API.
  * [iOS examples](https://github.com/tensorflow/tensorflow/tree/master/tensorflow/contrib/ios_examples) ⭐ 199,741 | 🐛 3,114 | 🌐 C++ | 📅 2026-09-13
...
* [NNPACK](https://github.com/Maratyszcza/NNPACK) ⭐ 1,711 | 🐛 49 | 🌐 C | 📅 2024-06-11 - Acceleration package for neural networks on multi-core CPUs. Prisma [uses](http://prisma-ai.com/libraries.html) this library in the mobile app.
...
* [BNNS](https://developer.apple.com/reference/accelerate/1912851-bnns) - Apple Basic neural network subroutines (BNNS) is a collection of functions that you use to implement and run neural networks, using previously obtained training data.
  * [BNNS usage examples](https://github.com/shu223/iOS-10-Sampler) ⭐ 3,269 | 🐛 4 | 🌐 Swift | 📅 2024-05-01 in iOS 10 sampler.
...
* [MobileNet-Caffe](https://github.com/shicai/MobileNet-Caffe) ⭐ 1,273 | 🐛 48 | 🌐 Python | 📅 2021-06-08 - Caffe Implementation of Google's MobileNets
...
* [OpenFace](https://github.com/TadasBaltrusaitis/OpenFace) ⭐ 7,753 | 🐛 361 | 🌐 MATLAB | 📅 2024-06-01 – a state-of-the art open source tool intended for facial landmark detection, head pose estimation, facial action unit recognition, and eye-gaze estimation.
...
* **Tesseract**
  * [Tesseract-OCR-iOS](https://github.com/gali8/Tesseract-OCR-iOS) ⭐ 4,220 | 🐛 120 | 🌐 C | 📅 2021-05-03
...
* [SwiftOCR](https://github.com/garnele007/SwiftOCR) ⭐ 4,630 | 🐛 86 | 🌐 Swift | 📅 2020-12-13
...
* [RandKit](https://github.com/aidangomez/RandKit) ⭐ 4 | 🐛 0 | 🌐 Swift | 📅 2017-07-06 - Swift framework for random numbers & distributions.
...
* [Charts](https://github.com/danielgindi/Charts) ⭐ 28,008 | 🐛 977 | 🌐 Swift | 📅 2026-03-07 - The Swift port of the MPAndroidChart.
* [iOS-Charts](https://github.com/danielgindi/ios-charts) ⭐ 28,008 | 🐛 977 | 🌐 Swift | 📅 2026-03-07
...
* [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,316 | 🐛 29 | 🌐 Python | 📅 2026-09-12
* [Machine Learning Courses](https://github.com/prakhar1989/awesome-courses#machine-learning) ⭐ 71,092 | 🐛 64 | 📅 2023-05-04
* [Awesome Data Science](https://github.com/okulbilisim/awesome-datascience) ⭐ 29,969 | 🐛 5 | 📅 2026-09-09
* [Awesome Computer Vision](https://github.com/jbhuang0604/awesome-computer-vision) ⭐ 23,553 | 🐛 92 | 📅 2024-05-17
* [Awesome Machine Learning for Cyber Security](https://github.com/jivoi/awesome-ml-for-cybersecurity) ⭐ 9,376 | 🐛 31 | 📅 2024-08-19
